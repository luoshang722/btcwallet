...
import (
	...
	"github.com/btcsuite/qtumutil"
)

var certificateFile = filepath.Join(qtumutil.AppDataDir("btcwallet", false), "rpc.cert")
...
func main() {
	...
	fmt.Println("Spendable balance: ", qtumutil.Amount(balanceResponse.Spendable))
}
```
